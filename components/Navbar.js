            ...
            <div className="container mx-auto flex justify-between items-center py-4">
                <div className={styles["nav-left"]}>
                    <Link href="/" className={styles["nav-logo"]}>
                        {theme === 'light' ?
                        <Image src={NavbarLogo} priority={true} alt="Navbar Logo" width={120} height={48} style={{objectFit:'contain'}}/>
                        :
                        <Image src={NavbarLogoWhite} priority={true} alt="Navbar Logo" width={120} height={48} style={{objectFit:'contain'}}/>
                        }
                    </Link>
